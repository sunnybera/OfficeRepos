...
$VaultName = "AZ-RSV-WE-SAP-BKP-PRD-LRS" #fetch automatically
$Subscription = "KAUSTCSPPRD" #fetch automatically
$ResourceGroup = "AZ_RG_WE_RSV_SAP_PRD" #fetch automatically
$SubscriptionId = "610b4239-2671-4780-93cf-8211107d16bf" #fetch automatically
