...
$usersList = Import-Csv "C:\11.2_cal2020_users.csv" 
...
foreach($row in $usersList) {
    ...
    #$storagename = "npcalrg002calsta"
    #$resourcegroupname = "npcalrg002"
    Write-Host "Setting StorageAccount"
    $vm = Set-AzureRmVMBootDiagnostics -VM $VM -Enable -ResourceGroupName $VnetResourceGroupName -StorageAccountName $AdminStorageName
