...
$VnetResourceGroupName = "np-cal-rg-002"
$VnetName = "np-cal-vnet-002"
$SubNetName = "np-cal-snet-002"
...
foreach($row in $usersList) {
    ...
    $vm = Set-AzureRmVMSourceImage -VM $vm -Skus "Data Science Virtual Machine - Windows 2019" -PublisherName MicrosoftWindowsServer -Offer WindowsServer -Version latest
