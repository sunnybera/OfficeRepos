...
e)  Will install IIS
f)  Will Add 2 Local Users with Admin Rights -- User IDs:  calibone, calibtwo / Password: 'azure@2020'
g)  Will disable IE Enhanced Security Configuration
h)  To disable IE enhanced internet security configure

Note:  Please Refer Run Book -  "Run Book-  Post-Deployment Configuration in Azure VM"
 
-------------------------------------------------------------------------------------------------------------------------
File Name     : 002.2_ForNewlyBuiltVM.ps1
Version       : 1.1
